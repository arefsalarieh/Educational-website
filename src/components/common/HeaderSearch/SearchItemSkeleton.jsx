  ...
  return (
    <div className="w-11/12 h-[120px] animate-pulse grid grid-cols-3 grid-rows-2 gap-4 shadow-shadowPrimaryFront cursor-pointer rounded-lg me-[6px]">
      <div className="col-span-1 row-span-2 my-2 ms-2 flex items-center justify-center w-11/12 h-11/12 rounded-lg bg-gray-300 dark:bg-gray-700">
        <svg
          class=" w-5/6 h-5/6 text-gray-200 dark:text-gray-600"
          aria-hidden="true"
      ...
      <div class="col-span-2 flex items-center indent-4 h-4.5 my-5 bg-gray-200 rounded-full dark:bg-gray-700 w-1/3 mb-4"></div>
      <div className="col-span-2 grid grid-cols-4 overflow-hidden text-sm">
        <div class="col-span-3 max-h-10 h-3 bg-gray-200 rounded-full dark:bg-gray-700 max-w-3/4 mb-2.5"></div>
        <div class="col-span-3 max-h-10 h-3 my-1 bg-gray-200 rounded-full dark:bg-gray-700 max-w-3/4 mb-2.5"></div>
      </div>
    </div>
  );
}
