...
const Course = ({
  ...
  const handleClick = () => {
    navigate("/MenuDetailCourses/" + idx);
  };
  ...
  const [courseStyle, setCourseStyle] = useState([
    ...
    {
      parent:
        "border  md:w-5/12 rounded-xl p-8 lg:flex shadow-2xl dark:shadow-shadowDarkUp dark:border-slate-400 m-6 md:m-0 cursor-pointer",
  ...
  return (
    <motion.div
      ...
      className={
        courseShape == "courses" ? courseStyle[0].parent : courseStyle[1].parent
      }
    >
      <div
        className={
          courseShape == "courses"
            ? courseStyle[0].firstDiv
            : courseStyle[1].firstDiv
        }
      >
        <img
          className={
            courseShape == "courses" ? courseStyle[0].img : courseStyle[1].img
          }
          src={src}
          alt=""
        />
      ...
      <div
        className={
          courseShape == "courses"
            ? courseStyle[0].secondDiv
            : courseStyle[1].secondDiv
        }
      >
        <h2
          className={
            courseShape == "courses" ? courseStyle[0].h2 : courseStyle[1].h2
          }
        >
          {courseName}
        </h2>
        <p
          className={
            courseShape == "courses"
              ? courseStyle[0].firstP
              : courseStyle[1].firstP
          }
        >
          مدرس : {teacher}{" "}
        </p>
        ...
        <button
          ...
          className={
            courseShape == "courses" ? courseStyle[0].but : courseStyle[1].but
          }
        >
          ثبت دوره
        </button>
