...
const Register = () => {
  ...
  const validation = yup.object().shape({
    name: yup.string().required("لطفا نام دوره را وارد کنید. "),
    number: yup.number().required("لطفا شماره تماس خود را وارد کنید."),
    nationalCode: yup.number().required("لطفا کد ملی وارد نمایید "),
    dateBitrthday: yup.date().required("لطفا تاریخ تولد خود را وارد نمایید"),
