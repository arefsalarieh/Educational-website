...
const EditProfile = () => {
  ...
  return (
    <div className=' w-10/12  py-10 mx-auto my-10 font-irSans'>
      ...
      <Formik onSubmit={onSubmit} initialValues={{ fname : '' , lname : '' , NationalCode : '' , gender : true , born : '' , job : '' , city : '' , email : '' , address : '' , desc : '' }}>
      {({values , handleSubmit, handleChange , setFieldValue })=>(
        <form onSubmit={handleSubmit} className=' lg:justify-between lg:px-4 lg:gap-4'>
          


          <div className=' mt-4 lg:w-5/12'>
            <label className='block text-center lg:text-right lg:pr-4' htmlFor='fname'>نام</label>
            <Input type='text' id='fname' name='fname'  value={values.fname} onChange={handleChange} className=''/>            
          </div>
          ...
          <div className=' mt-4 lg:w-5/12'>
            <label className='block text-center lg:text-right lg:pr-4' htmlFor='NationalCode'>کد ملی </label>
            <Input type='text' id='NationalCode' name='NationalCode' value={values.NationalCode} onChange={handleChange}/>            
          </div>

          <div className=' mt-4 lg:w-1/4'>
            <label className='block text-center lg:text-right lg:pr-4' >  جنسیت </label>

  
            <label className='inline text-center lg:text-right lg:pr-4' htmlFor='gender1'>  مرد </label>
            <Field type='radio' name='gender' id='gender1' value='true' />
            <label className='inline text-center lg:text-right lg:pr-4' htmlFor='gender2'>  زن </label>            
          ...
          <div className=' mt-4 lg:w-1/4'>
            ...
            <Input type='text' id='born' name='born' value={values.born} onChange={handleChange}/>            
          </div>

          <div className=' mt-4 lg:w-1/4'>
            <label className='block text-center  lg:text-right lg:pr-4' htmlFor='job'>  شغل</label>
            <Input type='text' id='job' name='job' className='w-full' value={values.job} onChange={handleChange}/>            
          </div>          
          ...
          <div className=' mt-4 lg:w-full'>
            ...
            <TextArea  id='desc' name='desc' value={values.desc} onChange={handleChange}  style={{ height:'200px' ,minHeight:'100px', maxHeight:'300px'}}/>            
          </div> 

          <div  className=' mt-4 w-full flex flex-col sm:flex-row flex-wrap  sm:justify-start gap-4 '>
            <Button type='submit' title='ثبت' backgroundColor='bg-green-400' borderWidth='border-none'></Button>                
