...
const DashboardItem = ({title , pic}) => {
  return (
    <div className='border-2 sm:w-5/12 lg:w-1/4 p-2 mt-4 rounded-t-xl border-gray-400 '>
        <div className='border rounded-xl bg-pannel '>
          <img src={pic} className='mx-auto mt-6' alt="" />  
        </div> 
        <h2 className='border text-center  my-6 font-sans  font-extrabold mx-auto'>{title} </h2>  
    </div>
  )
}
...
const Dashboard = () => {
  ...
  return (
    <div className='px-6 sm:flex sm:flex-wrap justify-around gap-2 font-irSans'>
