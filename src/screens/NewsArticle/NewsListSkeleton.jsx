    ...
    <div className="container animate-pulse mx-auto justify-center flex flex-wrap gap-6 p-3 lg:flex-row lg:flex-wrap">
        {[...Array(n)].map((e, i) => (
          <div className="xl:w-1/6 lg:w-1/5 md:w-1/4  xs:w-full sm:w-1/3  mx-auto justify-center shadow-lg  shadow-bg-[#ffffff] dark:shadow-shadowDarkFront  rounded-md p-3 cursor-pointer">
            ...
            <div class="h-5 bg-gray-200 rounded-full dark:bg-gray-700 w-3/4 mb-4"></div>
            <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-11/6 mb-4"></div>
            <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-5/6 mb-4"></div>
            <div className="flex justify-between">
              <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-3/6 mb-2"></div>
              <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 w-2/6 mb-2"></div>
            </div>
          </div>
        ))}
      </div>
