    ...
    <>
      ...
      <div className=" w-full md:w-5/6  items-center justify-center  bg-bgDetail mx-auto p-[26px] space-y-10  md:p-12">
        <div className="w-full flex flex-col gap-8">
          <div className=" bg-bgDivTopComm  whitespace-nowrap   rounded-md  align-middle  text-lg md:text-lg  py-2 md:py-4  text-bgTextTopComm pr:2 md:pr-8  font-irSans  font-bold">
