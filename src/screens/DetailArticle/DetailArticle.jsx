...
const DetailArticle = () => {
  ...
  return (
    <>
      {/* Global Container */}
      <div className=" w-full flex  flex-col  items-center  bg-bgDetail mx-auto p-5 ">
        {/* Top Container */}
        <div className="flex flex-col-reverse  sm:flex-row">
          {/* Right Side */}
          <div className="w-full flex flex-col gap-6 lg:w-2/3  mx-auto justify-center">
            <div className="flex  flex-row justify-start gap-12  m  sm:justify-start sm:gap-16  md:justify-start md:gap-16  lg:justify-start lg:gap-28">
              {/*title */}
              <div className="flex flex-col gap-2">
                <p className="text-sm font-bold whitespace-nowrap">عنوان خبر :</p>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-[13px] font-semibold whitespace-nowrap"> مقاله</p>
              </div>
            </div>
        ...
        <div className="w-full mt-14 mb-6">
          ...
          <div className="mx-auto relative bottom-4  items-center  bg-bgDetail  w-fit h-fit px-3">
            <p className="text-sm text-center">اخبار مرتبط</p>
          </div>
        </div>
