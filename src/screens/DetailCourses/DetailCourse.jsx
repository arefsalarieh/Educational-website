...
const DetailCourse = () => {
  ...
  const courseInfo =async () =>{
    const result = await http.get(`/Home/GetCourseDetails?CourseId=${idd}` )
    return result;
  }

  const {data , status} = useQuery(['courseDetail' , idd] , courseInfo )
        ...
        <div className="flex flex-col-reverse md:flex-row">
          ...
          <div className="w-full flex flex-col gap-6 lg:w-2/3  mx-auto justify-center">
            ...
            <div className="flex flex-col">
              <p className="text-sm font-bold font-irSans"> درباره دوره :</p>
              <p className="text-sm mt-4 text-justify font-irSans">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3 pr-2">
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <span className="text-[13px] font-irSans">
                    {status === 'success' && data.capacity} نفر                    
                  </span>
                </div>
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <span className="text-[13px] font-irSans">
                    {status === 'success' && data.courseStatusName}                     
                  </span>
                </div>
